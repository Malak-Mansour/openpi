...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_do_manual_delta",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="/l/users/malak.mansour/Datasets/do_manual/lerobot_from_hdf5/Malak-Mansour/DO_manual_lerobot", 
            base_config=DataConfig(
    ...
    TrainConfig(
        name="pi0_do_manual_teleop",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="/l/users/malak.mansour/Datasets/do_manual/teleop_lerobot_from_hdf5/Malak-Mansour/DO_manual_lerobot", 
            base_config=DataConfig(
                local_files_only=True,  # Set to True for local-only datasets.
                prompt_from_task=True,
            ),
    ...
    TrainConfig(
        name="pi0_do_manual_next",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="/l/users/malak.mansour/Datasets/do_manual/next_lerobot_from_hdf5/Malak-Mansour/DO_manual_lerobot", 
            base_config=DataConfig(
                local_files_only=True,  # Set to True for local-only datasets.
                prompt_from_task=True,
            ),
