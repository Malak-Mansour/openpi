"""
export HF_LEROBOT_HOME="/l/users/malak.mansour/Datasets/do_manual/teleop_lerobot_from_rlds"
uv run examples/libero/teleop_convert_do_rlds_to_lerobot.py --data_dir /l/users/malak.mansour/Datasets/do_manual/rlds 
--push_to_hub
"""
import os
import shutil
