"""
export HF_LEROBOT_HOME="/l/users/malak.mansour/Datasets/do_manual/next_lerobot_from_rlds"
uv run examples/libero/next_convert_do_rlds_to_lerobot.py --data_dir /l/users/malak.mansour/Datasets/do_manual/rlds 
--push_to_hub
"""
    ...
    for episode in raw_dataset:
        ...
        for i in range(len(steps)):
            ...
            if i < len(steps) - 1:
                ...
                next_action = np.zeros(7, dtype=np.float32)  # No motion at last step
