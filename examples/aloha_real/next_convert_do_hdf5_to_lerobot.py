...
Example usage:
export HF_LEROBOT_HOME="/l/users/malak.mansour/Datasets/do_manual/next_lerobot_from_hdf5"
uv run examples/aloha_real/next_convert_do_hdf5_to_lerobot.py --raw_dir /l/users/malak.mansour/Datasets/do_manual/hdf5 --repo_id Malak-Mansour/DO_manual_lerobot
"""
import h5py
import numpy as np
            ...
            for ep_key in f.keys():
                ...
                for i in range(len(states)):
                    ...
                    if i < len(states) - 1:
                        ...
                        next_action = np.zeros(7, dtype=np.float32)
